...
public class OnibusDto extends VeiculoDto{
    ...
    public OnibusDto(Long id, Boolean disponivel, String marca, String modelo, Integer anoFabricacao, Double capacidade, Double custoPorDia, String categoriaVeiculo, Integer numeroDeAssentos) {
